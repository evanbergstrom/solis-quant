...
package com.soliscode.finance.quant.math.interpolations

trait Extrapolator {
  var allowsExtrapolation: Boolean

  def enableExtrapolation(): Unit = allowsExtrapolation = true
  def disableExtrapolation(): Unit = allowsExtrapolation = false
}
